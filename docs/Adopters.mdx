...
| [OpenChoreo](https://github.com/openchoreo/openchoreo)          | A complete, open-source developer platform for Kubernetes.                         | [.conf](https://github.com/openchoreo/openchoreo/blob/main/internal/authz/casbin/rbac_model.conf) | [K8s adapter](https://github.com/openchoreo/openchoreo/blob/main/internal/authz/casbin/k8s_watcher.go) |
